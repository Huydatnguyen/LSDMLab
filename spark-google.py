...
def main():
	...
	val = int(input("Please enter the number of your question: "))
	...
	# 4. Do tasks with a low scheduling class have a higher probability of being evicted?
		...
		# read the input file into an RDD[String]
		task_events = sc.textFile("task_events/part-00000-of-00500.csv")
	...
	# 6. Are the tasks that request the more resources the ones that consume the more resources?
		...
		# import data and filter it (by removing rows that has missing values of resource request)
		resource_usage=sc.textFile("resource_usage/part-00000-of-00500.csv")
		...
		print(nb_tasks_big_rsc/rsc_big.count())
